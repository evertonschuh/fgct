...
abstract class JToolBarHelper
{
	...
	public static function title($title, $icon = '')
	{
		...
		$html =  '<h4 class="fw-bold py-3 mb-4">' . $icon . $title . '</h4>';
	 ...
	 * @since	1.0
	 */
	public static function custom($task = '', $icon = '', $iconOver = '', $alt = '', $listSelect = false)
	{
		$bar = JToolBar::getInstance('toolbar');
	 ...
	 * @since	1.0
	 */
	public static function modal($task = '', $icon = '', $alt = '', $list=false, $class='primary')
	{
		$bar = JToolBar::getInstance('toolbar');
		// Add a preview button.
		$bar->appendButton('Modal', $icon, $task, $alt, $list, $class);
	}
	...
	public static function customLink($href = '#', $icon = '', $iconOver = '', $alt = '')
	{
		$bar = JToolBar::getInstance('toolbar');
	 ...
	 * @since	1.0
	 */
	public static function featuredList($task = 'featured', $alt = 'JTOOLBAR_FEATURED')
	{
		$bar = JToolBar::getInstance('toolbar');
	...
	/**
	 * Writes a common 'unfeaturedList' button for a list of records.
	 *
	 * @param	string	$task	An override for the task.
	 * @param	string	$alt	An override for the alt text.
	 * @since	1.0
	 */
	public static function unfeaturedList($task = 'unfeatured', $alt = 'JTOOLBAR_UNFEATURED')
	{
		$bar = JToolBar::getInstance('toolbar');
	 ...
	 * @since	1.0
	 */
	public static function lockList($task = 'lock', $alt = 'JTOOLBAR_LOCKED')
	{
		$bar = JToolBar::getInstance('toolbar');
		// Add a publish button (list).
		$bar->appendButton('Standard', 'lock', $alt, $task, true);
	}
	 ...
	 * @since	1.0
	 */
	public static function unlockList($task = 'unlock', $alt = 'JTOOLBAR_UNLOCKED')
	{
		$bar = JToolBar::getInstance('toolbar');
		// Add an unpublish button (list).
		$bar->appendButton('Standard', 'unlock', $alt, $task, true);
	}
...
abstract class JSubInfoHelper
{
	...
	public static function addEntry($name, $link = '', $active = false)
	{
		$menu = JToolBar::getInstance('subinfo');
		$menu->appendButton($name, $link, $active);
	}
}
