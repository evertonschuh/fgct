...
class JRouterSite extends JRouter
{
	...
	protected function _parseRawRoute($uri = null)
	{
		$vars	= array();
		$app	= JApplication::getInstance('site');
	...
	protected function _parseSefRoute($uri = null)
	{
		$vars	= array();
		$app	= JApplication::getInstance('site');
		$menu	= $app->getMenu(true);
		 ...
		 */
		$this->_vars['option'] = 'com_easistemas';
		if (!empty($route) && isset($this->_vars['option'])) {
			...
			$path = JPATH_SITE . '/router/router.php';
	...
	protected function _buildRawRoute($uri = null)
	{
	}

	protected function _buildSefRoute($uri = null)
	{
		// Get the route
		$route = $uri->getPath();
...
*/
	...
	protected function _processParseRules($uri = null)
	{
	...
	protected function _processBuildRules($uri = null)
	{
