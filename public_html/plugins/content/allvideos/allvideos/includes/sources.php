...
// drive.google.com - http://www.drive.google.com//file/d/{SOURCE}/preview
"GoogleDrive" => "<iframe src=\"//drive.google.com/file/d/{SOURCE}/preview\" width=\"{WIDTH}\" height=\"{HEIGHT}\" frameborder=\"0\" allowfullscreen title=\"JoomlaWorks AllVideos Player\"></iframe>",
...
<script type=\"text/javascript\">
	allvideos.ready(function(){
		allvideos.embed({
			'url': '//soundcloud.com/oembed?format=js&iframe=true&callback=soundcloud{SOURCEID}&auto_play={PLAYER_AUTOPLAY}&maxwidth={WIDTH}&url={SOURCE}',
