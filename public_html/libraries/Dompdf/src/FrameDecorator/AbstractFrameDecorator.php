...
require_once(JPATH_LIBRARIES .DS. 'Dompdf' .DS. 'src' .DS.  'Frame' .DS.'FrameTreeList.php');
require_once(JPATH_LIBRARIES .DS. 'Dompdf' .DS. 'src' .DS.  'Frame' .DS.'Factory.php');
require_once(JPATH_LIBRARIES .DS. 'Dompdf' .DS. 'src' .DS.  'FrameReflower' .DS.'AbstractFrameReflower.php');
...
abstract class AbstractFrameDecorator extends Frame
{
    ...
    function split(Frame $child = null, $force_pagebreak = false)
    {
        ...
        if ($this instanceof BlockFrameDecorator) {
     ...
     */
    final function reflow(BlockFrameDecorator $block = null)
    {
