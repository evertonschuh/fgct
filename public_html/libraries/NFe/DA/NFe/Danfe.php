...
require_once(JPATH_LIBRARIES . DS . 'NFe'. DS . 'DA' . DS . 'Legacy' . DS . 'Dom.php');
require_once(JPATH_LIBRARIES . DS . 'NFe'. DS . 'DA' . DS . 'Legacy' . DS . 'Pdf.php');
require_once(JPATH_LIBRARIES . DS . 'NFe'. DS . 'DA' . DS . 'Legacy' . DS . 'Common.php');
