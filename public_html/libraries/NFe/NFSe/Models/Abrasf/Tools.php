...
require_once(JPATH_LIBRARIES . DS . 'NFe'. DS . 'NFSe' . DS . 'Models' . DS . 'Abrasf' . DS . 'Rps.php');
//require_once(JPATH_LIBRARIES . DS . 'NFe'. DS . 'NFSe' . DS . 'Models' . DS . 'Abrasf' . DS . 'Factories');
require_once(JPATH_LIBRARIES . DS . 'NFe'. DS . 'NFSe' . DS . 'Common' . DS . 'Tools.php');

class ToolsAbrasf extends ToolsBase
{
    ...
    public function consultarNfse(
		...
		require_once(JPATH_LIBRARIES . DS . 'NFe'. DS . 'NFSe' . DS . 'Models' . DS . 'Abrasf' . DS . 'Factories' . DS . 'ConsultarNfse.php');
