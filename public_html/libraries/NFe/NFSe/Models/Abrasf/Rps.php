...
require_once(JPATH_LIBRARIES . DS . 'NFe'. DS . 'NFSe' . DS . 'Common' . DS . 'DateTime.php');
...
require_once(JPATH_LIBRARIES . DS . 'NFe'. DS . 'NFSe' . DS . 'Common' . DS . 'Rps.php');

class RpsAbrasf extends RpsBase
{
    const TIPO_RPS = 1;
    const TIPO_MISTO = 2;
    const TIPO_CUPOM = 3;
     ...
     * @var array
     */
    public $infPrestador = array('tipo' => '', 'cnpjcpf' => '' , 'im' => '');
    /**
     * @var array
     */
    public $infTomador = array('tipo' => '', 'cnpjcpf' => '' , 'im' => '', 'razao' => '', 'tel' => '','email' => '');
    /**
     * @var array
     */
    public $infTomadorEndereco = array(
        'end' => '',
        'numero' => '',
        'complemento' => '',
        'bairro' => '',
     ...
     * @var array
     */
    public $infRpsSubstituido = array('numero' => '', 'serie' => '', 'tipo' => '');
    /**
     * @var array
     */
    public $infIntermediario = array('tipo' => '', 'cnpjcpf' => '' , 'im' => '', 'razao' => '');
    /**
     * @var array
     */
    public $infConstrucaoCivil = array('obra' => '', 'art' => '');
    /**
     * @var int
     */
    public $infNumero;
    ...
    {
        $this->infConstrucaoCivil = array('obra' => $codigoObra, 'art' => $art);
    }
