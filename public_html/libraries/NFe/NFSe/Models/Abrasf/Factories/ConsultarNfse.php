...
require_once(JPATH_LIBRARIES . DS . 'NFe'. DS . 'NFSe' . DS . 'Models' . DS . 'Abrasf' . DS . 'Factories' . DS . 'Header.php');
require_once(JPATH_LIBRARIES . DS . 'NFe'. DS . 'NFSe' . DS . 'Models' . DS . 'Abrasf' . DS . 'Factories' . DS . 'Factory.php');
...
class ConsultarNfse extends Factory
{
    ...
    public function render(
		...
		if (!empty(trim($numeroNFse))) {
            $content .= "<tsNumeroNfse>$numeroNFse</tsNumeroNfse>";
        }
