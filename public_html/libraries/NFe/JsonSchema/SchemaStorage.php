...
*/
require_once(JPATH_LIBRARIES . DS . 'NFe'. DS . 'JsonSchema' . DS . 'Constraints' . DS . 'BaseConstraint.php');
require_once(JPATH_LIBRARIES . DS . 'NFe'. DS . 'JsonSchema' . DS . 'Entity' . DS . 'JsonPointer.php');
require_once(JPATH_LIBRARIES . DS . 'NFe'. DS . 'JsonSchema' . DS . 'Exception' . DS . 'UnresolvableJsonPointerException.php');
require_once(JPATH_LIBRARIES . DS . 'NFe'. DS . 'JsonSchema' . DS . 'Uri' . DS . 'UriResolver.php');
...
require_once(JPATH_LIBRARIES . DS . 'NFe'. DS . 'JsonSchema' . DS .  'UriResolverInterface.php');
...
class SchemaStorage implements SchemaStorageInterface
{
    ...
    public function __construct(
        BaseUriRetrieverInterface $uriRetriever = null,
