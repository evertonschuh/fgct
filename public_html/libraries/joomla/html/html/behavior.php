...
abstract class JHtmlBehavior
{
	...
	public static function framework($extras = false, $debug = null)
	{
		...
		JHtml::_('script', '/assets/js/mootools-' . $type . '.js', false, true, false, false, $debug);
		JHtml::_('script', '/assets/js/core.js', false, true);
		JHtml::_('script', '/assets/js/util.js', false, true);
	...
	public static function formvalidation()
	{
		...
		// Include MooTools framework
		self::framework();
		JHtml::_('script', '/assets/js/validate.js', true, true);
			...
			"window.addEvent('domready', function(){
				...
				$$('.input-colorpicker').each(function(item){
					if (nativeColorUi) {
						...
						new MooRainbow(item, {
							id: item.id,
							imgPath: '" . JURI::root(true) . "/views/system/images/mooRainbow/',
