...
abstract class JHtmlImage
{
		...
		$asTag = true)
	{
		...
		{
			$path = JPATH_SITE . '/admin/views/' . $cur_template . '/images/' . $file;
			if (!isset($paths[$path]))
			{
				if (file_exists(JPATH_SITE . '/admin/views/' . $cur_template . '/images/' . $file))
				{
					$paths[$path] = 'views/' . $cur_template . '/images/' . $file;
				}
				else
				{
		...
		$asTag = true)
	{
		...
		{
			if (file_exists(JPATH_ADMINISTRATOR . '/views/' . $cur_template . '/images/' . $file))
			{
				$image = 'views/' . $cur_template . '/images/' . $file;
			}
			else
			{
