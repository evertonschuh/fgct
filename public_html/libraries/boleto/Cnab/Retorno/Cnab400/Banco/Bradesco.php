...
require_once(JPATH_LIBRARIES . DS . 'boleto' . DS . 'Cnab' . DS .  'Retorno' . DS .  'Cnab400' .DS .'AbstractRetorno.php');
require_once(JPATH_LIBRARIES . DS . 'boleto' . DS . 'Contracts' . DS .  'Boleto' . DS .'Boleto.php');
require_once(JPATH_LIBRARIES . DS . 'boleto' . DS . 'Contracts' . DS .  'Cnab' . DS .'RetornoCnab400.php');
