...
require_once(JPATH_LIBRARIES . DS . 'boleto' . DS . 'Contracts' . DS . 'Cnab' . DS . 'Retorno' . DS . 'Cnab400' . DS . 'Detalhe.php'); //getDetalhe()
require_once(JPATH_LIBRARIES . DS . 'boleto' . DS . 'Contracts' . DS . 'Cnab' . DS . 'Retorno' . DS . 'Cnab400' . DS . 'Header.php'); //getHeader()
require_once(JPATH_LIBRARIES . DS . 'boleto' . DS . 'Contracts' . DS . 'Cnab' . DS . 'Retorno' . DS . 'Cnab400' . DS . 'Trailer.php'); //getTrailer()

require_once(JPATH_LIBRARIES . DS . 'boleto' . DS . 'Cnab' . DS . 'Retorno' . DS . 'Cnab400' . DS . 'Detalhe.php'); //getDetalhe()
require_once(JPATH_LIBRARIES . DS . 'boleto' . DS . 'Cnab' . DS . 'Retorno' . DS . 'Cnab400' . DS . 'Header.php'); //getHeader()
require_once(JPATH_LIBRARIES . DS . 'boleto' . DS . 'Cnab' . DS . 'Retorno' . DS . 'Cnab400' . DS . 'Trailer.php'); //getTrailer()
//require_once(JPATH_LIBRARIES . DS . 'boleto' . DS . 'Cnab' . DS . 'Retorno' . DS . 'Cnab400' . DS . 'Detalhe.php'); //getDetalhe()
