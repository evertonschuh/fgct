...
require_once(JPATH_LIBRARIES . DS . 'boleto' . DS . 'Contracts' . DS . 'Cnab' . DS . 'Retorno' . DS . 'Cnab240' . DS . 'Detalhe.php');
...
class Detalhe implements Detalhe240Contract
{
    //use MagicTrait;
	...
	function toArray(Detalhe $linha)
	{
		
		return array(
			'ocorrencia' => $linha->getOcorrencia(),
			'ocorrenciaTipo' => $linha->getOcorrenciaTipo(),
			'ocorrenciaDescricao' => $linha->getOcorrenciaDescricao(),
			'numeroControle' => $linha->getNumeroControle(),
			'numeroDocumento' => $linha->getNumeroDocumento(),
			'nossoNumero' => $linha->getNossoNumero(),
			'carteira' => $linha->getCarteira(),
			'dataVencimento' => $linha->getDataVencimento(),
			'dataOcorrencia' => $linha->getDataOcorrencia(),
			'dataCredito' => $linha->getDataCredito(),
			'valor' => $linha->getValor(),
			'valorRecebido' => $linha->getValorRecebido(),
			'valorTarifa' => $linha->getValorTarifa(),
			'valorIOF' => $linha->getValorIOF(),
			'valorAbatimento' => $linha->getValorAbatimento(),
			'valorDesconto' => $linha->getValorDesconto(),
			'valorMora' => $linha->getValorMora(),
			'valorMulta' => $linha->getValorMulta(),
			'pagador' => array(
				'nome' => $linha->getPagador()->getNome(),
				'endereco' => $linha->getPagador()->getEndereco(),
				'bairro' => $linha->getPagador()->getBairro(),
				'cep' => $linha->getPagador()->getCep(),
				'uf' => $linha->getPagador()->getUf(),
				'cidade' => $linha->getPagador()->getCidade(),
				'documento' => $linha->getPagador()->getDocumento(),
				'nome_documento' => $linha->getPagador()->getNomeDocumento(),
				'endereco2' => $linha->getPagador()->getCepCidadeUf(),
			),
			'cheques' => $linha->getCheques(),
			'error' => $linha->getError(),
			);
