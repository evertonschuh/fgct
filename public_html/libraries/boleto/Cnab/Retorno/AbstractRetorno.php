...
require_once(JPATH_LIBRARIES . DS . 'boleto' . DS . 'Contracts' . DS . 'Cnab' . DS . 'Retorno' . DS . 'Cnab240' . DS . 'Header.php');
...
require_once(JPATH_LIBRARIES . DS . 'boleto' . DS . 'Contracts' . DS . 'Cnab' . DS . 'Retorno' . DS . 'Cnab400' . DS . 'Header.php');
require_once(JPATH_LIBRARIES . DS . 'boleto' . DS . 'Contracts' . DS . 'Cnab' . DS . 'Retorno' . DS . 'Cnab400' . DS . 'Trailer.php');
require_once(JPATH_LIBRARIES . DS . 'boleto' . DS . 'Util.php');


abstract class AbstractRetornoGeneric implements \Countable, \SeekableIterator
{
    /**
