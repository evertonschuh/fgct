...
require_once(JPATH_LIBRARIES . DS . 'boleto' . DS . 'Boleto'. DS . 'Render'. DS . 'Html.php');
//require_once(JPATH_LIBRARIES . DS . 'boleto' . DS . 'Boleto' . DS . 'Render'. DS . 'Pdf.php');


require_once(JPATH_LIBRARIES . DS . 'boleto' . DS . 'Contracts' . DS . 'Pessoa.php');
...
abstract class AbstractBoleto implements BoletoContract
{
     ...
     * @var array
     */
    protected $especiesCodigo = array();
    /**
     * Número do documento
     *
     * @var int
     ...
     * @var array
     */
    protected $instrucoes_impressao = array();
    /**
     ...
     * @var array
     */
    public $variaveis_adicionais = array();
    /**
     ...
     * @return string
     */
    public function getEspecieDocCodigo($default = 2)
    {
    ...
    {
        return array_slice((array)$this->instrucoes + array(null, null, null, null, null, null, null, null), 0, 8);
    }
    ...
    public function getInstrucoesImpressao()
    {
        if (!empty($this->instrucoes_impressao))
            return array_slice((array)$this->instrucoes_impressao + array(null, null, null, null, null), 0, 5);
        else
            return array();
    }
    ...
    {
        return array_slice((array)$this->descricaoDemonstrativo + array(null, null, null, null, null), 0, 5);
    }
    ...
    public function getCodigoBarras()
    {
        ...
        $dv = (in_array($resto, array(0, 10, 11))) ? 1 : $resto;
    ...
    public function getCodigoBancoComDv()
    {
        ...
        $semX = array(BoletoContract::COD_BANCO_CEF);
