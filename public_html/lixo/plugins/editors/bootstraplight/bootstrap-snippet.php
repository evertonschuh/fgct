...
if (file_exists('langs/' . addslashes($_GET['language']) . '.php')) {
    $lang = $_GET['language'];
} else { // default
    $lang = 'en_EN';
}
...
if ($allowEdit == 'true') { ?>
            <div class="row margin-bottom-md" id="new-snippet-form-wrapper">
                ...
                <div class="col-sm-8 col-xs-6 col-sm-offset-4 col-xs-offset-6">
                	...
                	<a href="http://codecanyon.net/item/tinymce-bootstrap-plugin-for-joomla/12525945"><p class="button button-primary button-large" style="height:auto !important;padding:20px !important"><strong>Get this feature on PRO version at</strong><br>http://codecanyon.net/item/tinymce-bootstrap-plugin-for-joomla/12525945</p></a>
...
if ($allowEdit == 'true') { ?>
    ...
    $('#delete-snippet-button', context).on('click', function () {
        if ($(this).hasClass('btn-danger')) {
            ...
            $('#code-wrapper', context).html('<a href="http://codecanyon.net/item/tinymce-bootstrap-plugin-for-joomla/12525945"><p class="button button-primary button-large" style="height:auto !important;padding:20px !important"><strong>Get this feature on PRO version at</strong><br>http://codecanyon.net/item/tinymce-bootstrap-plugin-for-joomla/12525945</p></a><button type="submit" class="btn btn-primary" id="delete-snippet-ok-button">OK</button>');
