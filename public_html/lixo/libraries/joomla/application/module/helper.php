...
*/
	...
	protected static function &_load()
	{
		...
		{		
					...
					$module = new stdClass();
					$module->id = '4'; ;
					$module->title = 'User Status';
					$module->module = 'mod_status';
					...
					$module = new stdClass();
					$module->id = '5'; ;
					$module->title = 'Sub Info';
					$module->module = 'mod_subinfo';
					$module->position = 'subinfo';
					$module->content = '';
					$module->showtitle ='1';
					$module->params = '';
					$module->menuid = '1';
...
/*
			if ($db->getErrorNum())
			{
				JError::raiseWarning(500, JText::sprintf('JLIB_APPLICATION_ERROR_MODULE_LOAD1', $db->getErrorMsg()));
				return $clean;
			}
*/
