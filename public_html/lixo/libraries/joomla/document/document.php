...
class JDocument extends JObject
{
	...
	/**
	 * Sets the canonical of the document
	 *
	 * @param   string  $canonical  The base URI to be set
	 *
	 * @return  JDocument instance of $this to allow chaining
	 *
	 */
	...
	/**
	 * Sets the breadcrumb of the document
	 *
	 * @param   string  $breadcrumb  The base URI to be set
	 *
	 * @return  JDocument instance of $this to allow chaining
	 *
	 */
	...
	/**
	 * Sets the breadcrumbURL of the document
	 *
	 * @param   string  $breadcrumbURL  The base URI to be set
	 *
	 * @return  JDocument instance of $this to allow chaining
	 *
	 */
	public function setBreadcrumbURL($breadcrumbURL)
	{
	 ...
	 * @since   11.1
	 */
	public function setCustonMetaTags($custonmetatags)
	{
		$this->custonmetatags = $custonmetatags;
	 ...
	 * @since    11.1
	 */
	public function getCustonMetaTags()
	{
		return $this->custonmetatags;
	}
	...
	/*
	public function getMetaFace()
	{
		return $this->MetaFace;
	}
	*/
