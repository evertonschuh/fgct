...
class JCacheControllerPage extends JCacheController
{
	...
	public function get($id = false, $group = 'page', $wrkarounds = true)
	{
		...
		$data = $this->cache->get($id = null, $group = null);
	 ...
	 * @since   11.1
	 */
	public function store($data = NULL, $id = NULL, $group = NULL) 
	{
	 ...
	 * @since   11.1
	 */
	protected function _setEtag($etag = null)
	{
