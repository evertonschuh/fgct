...
class JFile
{
	...
	/**
	 * Moves an uploaded file to a destination folder in resize
	 *
	 * @param   string   $src          The name of the php (temporary) uploaded file
	 * @param   string   $dest         The path (including filename) to move the uploaded file to
	 * @param   integer  $width  	   The number of pixel width image
	 * @param   integer  $height  	   The number of pixel height image 
	 * @param   boolean  $scale		   True to scale on
	 *
	 * @return  boolean  True on success
	 *
	 * @since   11.1
	 */
	public static function thumb($src, $dest, $width, $height, $scale = false)
    {
        @unlink($dest);
