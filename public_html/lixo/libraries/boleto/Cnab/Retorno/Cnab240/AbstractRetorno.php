...
*/
require_once(JPATH_LIBRARIES . DS . 'boleto' . DS . 'Cnab' . DS . 'Retorno' . DS . 'AbstractRetorno.php');
require_once(JPATH_LIBRARIES . DS . 'boleto' . DS . 'Contracts' . DS . 'Cnab' . DS . 'Retorno' . DS . 'Cnab240' . DS . 'HeaderLote.php');
require_once(JPATH_LIBRARIES . DS . 'boleto' . DS . 'Contracts' . DS . 'Cnab' . DS . 'Retorno' . DS . 'Cnab240' . DS . 'TrailerLote.php');

require_once(JPATH_LIBRARIES . DS . 'boleto' . DS . 'Cnab' . DS . 'Retorno' . DS . 'Cnab240' . DS . 'Detalhe.php'); //getDetalhe()
require_once(JPATH_LIBRARIES . DS . 'boleto' . DS . 'Cnab' . DS . 'Retorno' . DS . 'Cnab240' . DS . 'Header.php'); //getHeader()
require_once(JPATH_LIBRARIES . DS . 'boleto' . DS . 'Cnab' . DS . 'Retorno' . DS . 'Cnab240' . DS . 'HeaderLote.php'); //getHeader()
require_once(JPATH_LIBRARIES . DS . 'boleto' . DS . 'Cnab' . DS . 'Retorno' . DS . 'Cnab240' . DS . 'Trailer.php'); //getTrailer()
require_once(JPATH_LIBRARIES . DS . 'boleto' . DS . 'Cnab' . DS . 'Retorno' . DS . 'Cnab240' . DS . 'TrailerLote.php'); //getTrailer()
...
abstract class AbstractRetorno extends AbstractRetornoGeneric
{
    ...
    public function processar()
    {
        ...
        if (method_exists($this, 'finalize')) {
            call_user_func(array($this, 'finalize'));
        }
