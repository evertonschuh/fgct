...
class Santander extends AbstractRemessa implements RemessaContract 
{
     ...
     * @var array
     */
    protected $carteiras = array(101, 201);
    ...
    protected function segmentoP(BoletoContract $boleto)
    {
        ...
        $this->add(142, 142, Util::formatCnab('9', ($boleto->getDesconto()>0 ? 1 : ''), 1));
        ...
        $this->add(196, 220, '');
        $this->add(221, 221, Util::formatCnab('9', ($boleto->getDiasProtesto() >0 ? 1 :0), 1));
    ...
    public function segmentoQ(BoletoContract $boleto)
    {
        ...
        $this->add(15, 15, '');
        $this->add(16, 17, Util::formatCnab('9', 01, 2));
        $this->add(18, 18, Util::formatCnab('9', (strlen(Util::onlyNumbers($boleto->getPagador()->getDocumento()))>12 ? 2 : 1), 1));
    ...
    public function segmentoR(BoletoContract $boleto)
    {
        ...
        $this->add(19, 26, Util::formatCnab('9', 0, 8));
        $this->add(27, 41, Util::formatCnab('9', 0, 15));
        $this->add(42, 65, '');
        $this->add(66, 66, 2);
        $this->add(67, 74, Util::formatCnab('9', 0, 8));
        $this->add(75, 89, Util::formatCnab('9', Util::onlyNumbers($boleto->getMulta()), 15));
        $this->add(90, 99, '');
        $this->add(100, 139, '');
        $this->add(140, 179, '');
        $this->add(180, 240, '');
