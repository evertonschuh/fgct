...
require_once(JPATH_LIBRARIES . DS . 'boleto' . DS . 'Container' . DS .  'Container.php');
require_once(JPATH_LIBRARIES . DS . 'boleto' . DS . 'View' . DS .  'Factory.php');
require_once(JPATH_LIBRARIES . DS . 'boleto' . DS . 'View' . DS . 'Engines' . DS .  'EngineResolver.php');
require_once(JPATH_LIBRARIES . DS . 'boleto' . DS . 'View' . DS .  'FileViewFinder.php');
require_once(JPATH_LIBRARIES . DS . 'boleto' . DS . 'Filesystem' . DS .  'Filesystem.php');
require_once(JPATH_LIBRARIES . DS . 'boleto' . DS . 'Bus' . DS .  'Dispatcher.php');
class Blade
{
    /**
