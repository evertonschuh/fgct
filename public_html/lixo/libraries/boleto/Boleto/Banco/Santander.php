...
require_once(JPATH_LIBRARIES . DS . 'boleto' . DS . 'Boleto' . DS . 'AbstractBoleto.php');
...
class SantanderBoleto extends AbstractBoleto implements BoletoContract
{
     ...
     * @var array
     */
    protected $carteirasNomes = array('101' => 'Cobrança Simples ECR', '102' => 'Cobrança Simples CSR', '201' => 'Penhor');
    /**
    ...
    public function setDiasBaixaAutomatica($baixaAutomatica)
    {
        ...
        if (!in_array($baixaAutomatica, array(15, 30))) {
