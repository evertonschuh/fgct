...
require_once(JPATH_LIBRARIES .DS. 'Dompdf' .DS. 'src' .DS. 'Renderer' .DS. 'AbstractRenderer.php');
require_once(JPATH_LIBRARIES .DS. 'Dompdf' .DS. 'src' .DS. 'Renderer' .DS. 'Block.php');
require_once(JPATH_LIBRARIES .DS. 'Dompdf' .DS. 'src' .DS. 'Renderer' .DS. 'Image.php');
require_once(JPATH_LIBRARIES .DS. 'Dompdf' .DS. 'src' .DS. 'Renderer' .DS. 'Inline.php');
require_once(JPATH_LIBRARIES .DS. 'Dompdf' .DS. 'src' .DS. 'Renderer' .DS. 'ListBullet.php');
require_once(JPATH_LIBRARIES .DS. 'Dompdf' .DS. 'src' .DS. 'Renderer' .DS. 'TableCell.php');
require_once(JPATH_LIBRARIES .DS. 'Dompdf' .DS. 'src' .DS. 'Renderer' .DS. 'TableRowGroup.php');
require_once(JPATH_LIBRARIES .DS. 'Dompdf' .DS. 'src' .DS. 'Renderer' .DS. 'Text.php');
    ...
    protected function _render_frame($type, $frame)
    {
        ...
        if (!isset($this->_renderers[$type])) {
            ...
            switch ($type) {
                ...
                case "table-row-group":
                    $this->_renderers[$type] = new TableRowGroupRenderer($this->_dompdf);
                    break;

                case "list-bullet":
                    $this->_renderers[$type] = new ListBulletRenderer($this->_dompdf);
                    break;
