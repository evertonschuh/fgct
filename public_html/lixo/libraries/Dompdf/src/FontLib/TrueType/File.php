...
require_once(JPATH_LIBRARIES .DS. 'Dompdf' .DS. 'src' .DS. 'FontLib' .DS. 'AdobeFontMetrics.php');
require_once(JPATH_LIBRARIES .DS. 'Dompdf' .DS. 'src' .DS. 'FontLib' .DS. 'Font.php');
require_once(JPATH_LIBRARIES .DS. 'Dompdf' .DS. 'src' .DS. 'FontLib' .DS. 'BinaryStream.php');

require_once(JPATH_LIBRARIES .DS. 'Dompdf' .DS. 'src' .DS. 'FontLib' .DS. 'Table' .DS. 'Table.php');
require_once(JPATH_LIBRARIES .DS. 'Dompdf' .DS. 'src' .DS. 'FontLib' .DS. 'Table' .DS. 'DirectoryEntry.php');
require_once(JPATH_LIBRARIES .DS. 'Dompdf' .DS. 'src' .DS. 'FontLib' .DS. 'Table' .DS. 'Type' .DS. 'glyf.php');
require_once(JPATH_LIBRARIES .DS. 'Dompdf' .DS. 'src' .DS. 'FontLib' .DS. 'Table' .DS. 'Type' .DS. 'name.php');
require_once(JPATH_LIBRARIES .DS. 'Dompdf' .DS. 'src' .DS. 'FontLib' .DS. 'Table' .DS. 'Type' .DS. 'nameRecord.php');
require_once(JPATH_LIBRARIES .DS. 'Dompdf' .DS. 'src' .DS. 'FontLib' .DS. 'TrueType' .DS. 'Header.php');
 ...
 * @package php-font-lib
 */
class FileTrueType extends BinaryStream {
  /**
   * @var Header
   */
  public $header = array();
  ...
  function parseHeader() {
    ...
    $this->header = new HeaderTrueType($this);
    $this->header->parse();
  }
  ...
  function parseTableEntries() {
	...
	require_once(JPATH_LIBRARIES .DS. 'Dompdf' .DS. 'src' .DS. 'FontLib' .DS.  str_replace(array('File'), '', $type) .DS. 'TableDirectoryEntry.php');
