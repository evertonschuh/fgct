...
class PHPExcel_IOFactory
{
	...
	public static function createWriter(PHPExcel $phpExcel, $writerType = '') {
		// Search type
		$searchType = 'IWriter';
		require_once(JPATH_LIBRARIES .DS. 'phpexcel' . DS. 'library' .DS. 'PHPExcel' . DS. 'Writer' . DS. 'Excel2007.php');
		// Include class
	...
	public static function createReader($readerType = '') {
		// Search type
		$searchType = 'IReader';
		require_once(JPATH_LIBRARIES .DS. 'phpexcel' . DS. 'library' .DS. 'PHPExcel' . DS. 'Reader' . DS. 'Excel2007.php');
		// Include class
		foreach (self::$_searchLocations as $searchLocation) {
			if ($searchLocation['type'] == $searchType) {
