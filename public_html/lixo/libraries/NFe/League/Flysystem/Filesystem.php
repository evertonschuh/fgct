...
require_once(JPATH_LIBRARIES . DS . 'NFe'. DS . 'League' . DS . 'Flysystem' . DS . 'Adapter' . DS. 'CanOverwriteFiles.php');
require_once(JPATH_LIBRARIES . DS . 'NFe'. DS . 'League' . DS . 'Flysystem' . DS . 'Plugin' . DS. 'PluggableTrait.php');
require_once(JPATH_LIBRARIES . DS . 'NFe'. DS . 'League' . DS . 'Flysystem' . DS . 'Util' . DS. 'ContentListingFormatter.php');

require_once(JPATH_LIBRARIES . DS . 'NFe'. DS . 'League' . DS . 'Flysystem' . DS . 'FilesystemInterface.php');
require_once(JPATH_LIBRARIES . DS . 'NFe'. DS . 'League' . DS . 'Flysystem' . DS . 'ConfigAwareTrait.php');
require_once(JPATH_LIBRARIES . DS . 'NFe'. DS . 'League' . DS . 'Flysystem' . DS . 'Adapter' . DS. 'Local.php');

require_once(JPATH_LIBRARIES . DS . 'NFe'. DS . 'League' . DS . 'Flysystem' . DS . 'FileNotFoundException.php');
require_once(JPATH_LIBRARIES . DS . 'NFe'. DS . 'League' . DS . 'Flysystem' . DS . 'Plugin' . DS. 'AbstractPlugin.php');
