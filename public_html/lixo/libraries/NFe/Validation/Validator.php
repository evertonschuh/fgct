...
*/
require_once(JPATH_LIBRARIES . DS . 'NFe'. DS . 'Validation' . DS . 'Factory.php');
require_once(JPATH_LIBRARIES . DS . 'NFe'. DS . 'Validation' . DS . 'Exceptions' . DS . 'AllOfException.php');
...
require_once(JPATH_LIBRARIES . DS . 'NFe'. DS . 'Validation' . DS . 'Rules' . DS . 'Key.php');
 ...
 */
class RValidator extends AllOf
{
    ...
    {
        if (!static::$factory instanceof RFactory) {
            static::$factory = new RFactory();
        }
