...
require_once(JPATH_LIBRARIES . DS . 'NFe'. DS . 'JsonSchema' . DS . 'Exception' . DS . 'InvalidSchemaMediaTypeException.php');
require_once(JPATH_LIBRARIES . DS . 'NFe'. DS . 'JsonSchema' . DS . 'Exception' . DS . 'JsonDecodingException.php');
require_once(JPATH_LIBRARIES . DS . 'NFe'. DS . 'JsonSchema' . DS . 'Exception' . DS . 'ResourceNotFoundException.php');
require_once(JPATH_LIBRARIES . DS . 'NFe'. DS . 'JsonSchema' . DS . 'Uri' . DS . 'Retrievers' . DS . 'FileGetContents.php');
