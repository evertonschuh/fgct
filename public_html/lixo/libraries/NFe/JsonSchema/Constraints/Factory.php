...
require_once(JPATH_LIBRARIES . DS . 'NFe'. DS . 'JsonSchema' . DS . 'SchemaStorage.php');
require_once(JPATH_LIBRARIES . DS . 'NFe'. DS . 'JsonSchema' . DS . 'SchemaStorageInterface.php');
require_once(JPATH_LIBRARIES . DS . 'NFe'. DS . 'JsonSchema' . DS . 'Uri' . DS . 'UriRetriever.php');
require_once(JPATH_LIBRARIES . DS . 'NFe'. DS . 'JsonSchema' . DS . 'UriRetrieverInterface.php');
...
class Factory
{
     ...
     */
    protected $errorContext = JsonValid::ERROR_DOCUMENT_VALIDATION;

    /**
     * @var array
     */
    protected $constraintMap = array(
        'array' =>  'CollectionConstraint' ,
    ...
    public function getTypeCheck()
    {
		...
		require_once(JPATH_LIBRARIES . DS . 'NFe'. DS . 'JsonSchema' . DS . 'Constraints' . DS . 'TypeCheck' . DS . 'LooseTypeCheck.php');
		require_once(JPATH_LIBRARIES . DS . 'NFe'. DS . 'JsonSchema' . DS . 'Constraints' . DS . 'TypeCheck' . DS . 'StrictTypeCheck.php');
    ...
    public function createInstanceFor($constraintName)
    {
        ...
        if (!isset($this->instanceCache[$constraintName])) {
			...
			$className = $this->constraintMap[$constraintName];
			
			//print_r( $className );
			require_once(JPATH_LIBRARIES . DS . 'NFe' . DS . 'JsonSchema' . DS . 'Constraints' . DS .  $className . '.php');
			
			//exit;
            $this->instanceCache[$constraintName] = new $className();
        }
