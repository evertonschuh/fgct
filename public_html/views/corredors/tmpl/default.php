...
<form method="post" name="adminForm">
        ...
        <div class="card-header border-bottom">
            ...
            <div class="d-flex justify-content-between align-items-center row py-2 gap-3 gap-md-0">
                <div class="col-md-4 user_role">
                    <select id="categoria" name="categoria" class="form-select text-capitalize" onchange="this.form.submit()">
                        <option value="">- Categorias de Corredores -</option>
                        <?php echo JHtml::_('select.options',  $this->categorias, 'value', 'text', $this->state->get('filter.categoria'));?>
                   
                    </select>
                </div>
                <div class="col-md-4 user_plan">
                    <select id="grupo" name="grupo" class="form-select text-capitalize" onchange="this.form.submit()">
                        <option value="">- Grupo de Corrida -</option>
                        <?php echo JHtml::_('select.options',  $this->grupos, 'value', 'text', $this->state->get('filter.grupo'));?>
                    ...
                    <div class="col-md-10">
                        <div class="dt-action-buttons text-xl-end text-lg-start text-md-end text-start d-flex align-items-center justify-content-end flex-md-row flex-column mb-3 mb-md-0">
                            ...
                            <div class="dt-buttons btn-group flex-wrap">
                                ...
                                <a class="btn add-new btn-primary" href="<?php echo JRoute::_('index.php?view=corredor&cid=');?>">
                                    <span>
                                        <i class="bx bx-plus me-0 me-sm-1"></i>
                                        <span class="d-none d-sm-inline-block">Adicionar Novo Corredor</span>
                                    </span>
</a> 
                            </div>
                        </div>
                ...
                <table class="datatables-users table border-top dataTable no-footer dtr-column">
                    <thead>
                        <tr>
                            ...
                            <th class="sorting sorting_desc"><?php echo JHtml::_('grid.sort',  'Nome', 'name_corredor', $listDirn, $listOrder); ?></th>
                            <th class="sorting"><?php echo JHtml::_('grid.sort', 'E-mail', 'email_corredor', $listDirn, $listOrder); ?></th>
                            <th class="sorting"><?php echo JHtml::_('grid.sort', 'CPF', 'cpf_corredor', $listDirn, $listOrder); ?></th>
                            <th class="sorting text-center"><?php echo JHtml::_('grid.sort', 'Categoria', 'name_corredor_categoria', $listDirn, $listOrder); ?></th>
                            <th class="sorting text-center"><?php echo JHtml::_('grid.sort', 'Grupo', 'name_corredor_grupo', $listDirn, $listOrder); ?></th>
                            <th class="sorting text-center"><?php echo JHtml::_('grid.sort', 'Status', 'status_corredor', $listDirn, $listOrder); ?></th>
    ...
    <input type="hidden" name="controller" value="corredors" />
    <input type="hidden" name="view" value="corredors" />
