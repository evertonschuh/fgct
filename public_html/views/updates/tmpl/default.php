                ...
                <table class="datatables-users table border-top dataTable no-footer dtr-column">
                    <thead>
                        <tr>
                            ...
                            <th class="sorting"><?php echo JHtml::_('grid.sort', 'Tipo', 'tipo_executa_pf_update', $listDirn, $listOrder); ?></th>
                            <th class="sorting text-center"><?php echo JHtml::_('grid.sort', 'Solicitação', 'register_pf_update', $listDirn, $listOrder); ?></th>
