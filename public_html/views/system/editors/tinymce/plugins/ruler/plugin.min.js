...
tinymce.PluginManager.add('ruler', function(editor, url) {
  ...
  const pluginManager = tinymce.util.Tools.resolve("tinymce.PluginManager");
    ...
    editor.addCommand("mceRulerRecalculate", function() {
      //alert('dfgdfg');
      //Tava colocando uma margin absurda
      const $document = editor.getDoc();/*
      const $breaks = $document.querySelectorAll(`p`);
...
/*
          ...
          var element = editor.dom.getParent(editor.selection.getNode(), 'p');
...
*/
         // editor..getParents('p',function() {
          //alert(tinymce.activeEditor.selection.getNode().nodeName);
          /*
          editor.getParents(function() {
            alert(editor.getParam('height'));
            //alert($(this).height());
              /*
