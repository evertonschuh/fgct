  ...
  var pagebreak = (function () {
      ...
      tinymce.PluginManager.add("pagebreak", function (editor, url) {
        ...
        editor.ui.registry.addButton('pagebreak', {
          ...
          tooltip: 'Page break',
          onAction: function () {
            return  editor.insertContent('<p class="mce-pagebreak" style="page-break-after: always;"></p>');
          }
        });
...
(function () {
    ...
    var getPlaceholderHtml = function () {
      return '<!-- pagebreak --><span class="mce-pagebreak" style="page-break-after: always;"></span>';
      ...
      editor.on('PreInit', function () {
        editor.serializer.addNodeFilter('img', function (nodes) {
          ...
          while (i--) {
            ...
            if (className && className.indexOf('mce-pagebreak11') !== -1) {
    ...
    var register = function (editor) {
      ...
      editor.addCommand('mcePageBreak', function () {
        if (shouldSplitBlock(editor)) {
          editor.insertContent('<!-- pagebreak --><span class="mce-pagebreak" style="page-break-after: always;"></span>');
        } else {
          editor.insertContent('<!-- pagebreak --><span class="mce-pagebreak" style="page-break-after: always;"></span>');
        }
      });
