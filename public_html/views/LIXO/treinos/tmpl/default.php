...
<form method="post" name="adminForm">
                ...
                <table class="datatables-users table border-top dataTable no-footer dtr-column">
                    <thead>
                        <tr>
                            ...
                            <th class="sorting sorting_desc"><?php echo JHtml::_('grid.sort',  'Nome', 'name_treino', $listDirn, $listOrder); ?></th>
                            <th class="sorting text-center"><?php echo JHtml::_('grid.sort', 'Atletas Vinculados', 'total_treino', $listDirn, $listOrder); ?></th>
                            <th class="sorting text-center"><?php echo JHtml::_('grid.sort', 'Status', 'status_treino', $listDirn, $listOrder); ?></th>
    ...
    <input type="hidden" name="controller" value="treinos" />
    <input type="hidden" name="view" value="treinos" />
