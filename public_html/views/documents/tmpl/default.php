                ...
                <table class="datatables-users table border-top dataTable no-footer dtr-column">
                    <thead>
                        <tr> 
                            ...
                            <th class="sorting sorting_desc"><?php echo JHtml::_('grid.sort', 'Documento', 'name_documento', $listDirn, $listOrder); ?></th>
                            <th class="sorting text-center"><?php echo JHtml::_('grid.sort', 'Número', 'numero_documento_numero', $listDirn, $listOrder); ?></th>
                            <th class="sorting text-center"><?php echo JHtml::_('grid.sort', 'Registro', 'register_documento_numero', $listDirn, $listOrder); ?></th>
                            <th class="sorting text-center"><?php echo JHtml::_('grid.sort',  'Id', 'id_documento_numero', $listDirn, $listOrder); ?></th>
