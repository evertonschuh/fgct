            ...
            <div class="form-inline">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <select name="registrado" class="form-control pull-right" onchange="this.form.submit()" >
                            <?php 
                        ...
                        <select id="metodos" name="metodos" class="form-control pull-right" onchange="this.form.submit()">
                        ...
                        <select id="anuidades" name="anuidades" class="form-control pull-right" onchange="this.form.submit()">
                        ...
                        <select id="produtos" name="produtos" class="form-control pull-right" onchange="this.form.submit()">
