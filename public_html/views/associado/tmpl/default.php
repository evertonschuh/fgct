...
if ( !empty( $this->item->image_corredor )):
    $imageUser = $resize->resize(JPATH_MEDIA .DS. 'images' .DS. 'avatar'  .DS. $this->item->image_corredor, 100, 100, 'cache/' . $this->item->image_corredor, 'manterProporcao');
else:
...
<form method="post" name="adminForm" enctype="multipart/form-data" class="form-validate">
    <div class="row">
        <div class="col-md-12">
         <?php if(isset($this->item->id_corredor)): ?> 
            <ul class="nav nav-pills flex-column flex-md-row mb-3">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo JRoute::_('index.php?view=ccategoria&layout=desempenho&cid[]=' . $this->item->id_corredor, false); ?>">
                        <i class="bx bx-run me-1"></i> Desempenho
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo JRoute::_('index.php?view=ccategoria&layout=pagamentos&cid[]=' . $this->item->id_corredor_categoria, false); ?>">
            ...
            <div class="card mb-4">
                <div class="card-header sticky-element  d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row">
                    <div class="row">
                        <div class="col-md-12">
                            <h5 class="card-title mb-sm-0 me-2">Cadastro do Corredor</h5>
                            <?php if($this->item->status_corredor < 0 ): ?>
                                <span class="badge bg-label-secondary mt-3">
                                    <span class="badge bg-label-secondary">
                                        Item na Lixeira
                                    <span>
                                </span>
                                <input name="status_corredor" value="<?php echo $this->item->status_corredor;?>" type="hidden">
                            <?php else: ?>
                            <div class="form-check form-switch mt-3">
                                <input value="1" class="form-check-input" name="status_corredor" <?php echo $this->item->status_corredor == 1 ? 'checked="checked"' :'';?> type="checkbox" id="checkStatus">
                                <label class="form-check-label" for="checkStatus"><?php echo $this->item->status_corredor == 1 ? 'Ativo' : 'Inativo';?></label>
                            </div>
                            <?php endif; ?>
                        </div>
                    </div>
                ...
                <div class="card-body">
                        ...
                        <div class="col-md mb-md-0 mb-2">
                            <div class="d-flex align-items-start align-items-sm-center gap-4">
                                <img
                                    ...
                                    alt="user-avatar"
                                    class="d-block rounded user-corredor"
                                    height="100"
                                    width="100"
                                />
                                <input type="hidden" name="image_corredor" value="<?php echo $this->item->image_corredor; ?>" />
                                ...
                                <div class="button-wrapper">
                                    ...
                                    <div class="col mb-2">
                                        <?php if ( !empty( $this->item->image_corredor )): ?>
                                        <fieldset class="checkbox-img-remove">
                                            <label>
                                                <input type="checkbox" name="remove_image_corredor" value="1" />
                        ...
                        <div class="col-md float-rigth">
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    <label class="form-label" for="id_estado">Categoria do Corredor</label>
                                    <select name="id_corredor_categoria" class="select2 form-select">
                                        <option disabled selected class="default" value=""><?php echo JText::_('- Categoria do Corredor -'); ?></option>
                                        <?php echo JHTML::_('select.options',  $this->categorias, 'value', 'text',  $this->item->id_corredor_categoria); ?>    
                                    </select>    
                                </div>  
                                <div class="mb-3 col-md-6">
                                    <label class="form-label" for="id_cidade">Grupo de Corrida</label>
                                    <select id="id_corredor_grupo" name="id_corredor_grupo" class="select2 form-select">
                                        <option disabled selected class="default" value=""><?php echo JText::_('- Grupo de Corrida -'); ?></option>
                                        <?php echo JHTML::_('select.options',  $this->grupos, 'value', 'text', $this->item->id_corredor_grupo); ?>   
                                    </select>    
                                </div> 
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="mb-3 col-md-8">
                            <label for="name_corredor" class="form-label">Nome Completo</label>
                            <input
                                class="form-control required"
                                type="text"
                                id="name_corredor"
                                name="name_corredor"
                                value="<?php echo $this->item->name_corredor; ?>"
                                autofocus
                            />
                        </div>
                        <div class="mb-3 col-md-4">
                            <label for="email_corredor" class="form-label">E-mail</label>
                            <input
                                class="form-control"
                                type="text"
                                id="email_corredor"
                                name="email_corredor"
                                value="<?php echo $this->item->email_corredor; ?>"
                                placeholder="email"
                            />
                        </div>
                        <div class="mb-3 col-md-3">
                            <label for="cpf_corredor" class="form-label">CPF</label>
                            <input class="form-control required validate-cpf" type="text" name="cpf_corredor" id="cpf_corredor" value="<?php echo $this->item->cpf_corredor; ?>" />
                        </div>
                        <div class="mb-3 col-md-3" class="dte">
                        <label for="data_nascimento_corredor" class="form-label">Data de Nascimento</label>
                            <input class="form-control date" 
                                   type="text" 
                                   value="<?php echo $this->item->data_nascimento_corredor ? JHtml::date(JFactory::getDate($this->item->data_nascimento_corredor, $siteOffset)->toISO8601(), 'DATE_FORMAT') : ''; ?>" 
                                   name="data_nascimento_corredor" 
                                   id="data_nascimento_corredor"
                            />
                        </div>
                        <div class="mb-3 col-md-3">
                            <label class="form-label" for="tel_residencial_corredor">Telefone</label>
                            <div class="input-group input-group-merge">
                                <span class="input-group-text">BR (55)</span>
                                <input
                                    type="text"
                                    id="tel_residencial_corredor"
                                    name="tel_residencial_corredor"
                                    class="form-control"
                                    placeholder="Telefone"
                                    value="<?php echo $this->item->tel_residencial_corredor; ?>" 
                                />
                            </div>
                        </div>
                        <div class="mb-3 col-md-3">
                            <label class="form-label" for="tel_celular_corredor">Celular</label>
                            <div class="input-group input-group-merge">
                                <span class="input-group-text">BR (55)</span>
                                <input
                                    type="text"
                                    id="tel_celular_corredor"
                                    name="tel_celular_corredor"
                                    class="form-control"
                                    placeholder="Celular"
                                    value="<?php echo $this->item->tel_celular_corredor; ?>" 
                                />
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        <div class="mb-3 col-md-3">
                            <label class="form-label" for="cep_corredor">CEP</label>
                            <div class="input-group input-group-merge">
                                <input
                                    type="text"
                                    name="cep_corredor"
                                    ...
                                    class="form-control"
                                    placeholder="CEP"
                                    value="<?php echo $this->item->cep_corredor; ?>" 
                                />
                                <button class="btn btn-outline-primary" type="button" id="complete"><i class='bx bx-search'></i></button>
                            </div>
                        </div>
                        <div class="mb-3 col-md-6">
                            <label class="form-label" for="logradouro_corredor">Endereço</label>
                            <div class="input-group input-group-merge">
                                <input
                                    type="text"
                                    id="logradouro_corredor"
                                    name="logradouro_corredor"
                                    class="form-control"
                                    placeholder="Endereço"
                                    value="<?php echo $this->item->logradouro_corredor; ?>" 
                                />
                            </div>
                        </div>
                        <div class="mb-3 col-md-3">
                            <label class="form-label" for="numero_corredor">Número</label>
                            <div class="input-group input-group-merge">
                                <input
                                    type="text"
                                    id="numero_corredor"
                                    ...
                                    class="form-control"
                                    placeholder="Número"
                                    value="<?php echo $this->item->numero_corredor; ?>" 
                                />
                            </div>
                        </div>

                        <div class="mb-3 col-md-6">
                            <label class="form-label" for="complemento_corredor">Complemento</label>
                            <div class="input-group input-group-merge">
                                <input
                                    type="text"
                                    id="complemento_corredor"
                                    name="complemento_corredor"
                                    class="form-control"
                                    placeholder="Complemento"
                                    value="<?php echo $this->item->complemento_corredor; ?>" 
                                />
                            </div>
                        </div>
                        <div class="mb-3 col-md-6">
                            <label class="form-label" for="bairro_corredor">Bairro</label>
                            <div class="input-group input-group-merge">
                                <input
                                    type="text"
                                    id="bairro_corredor"
                                    name="bairro_corredor"
                                    class="form-control"
                                    placeholder="Bairro"
                                    value="<?php echo $this->item->bairro_corredor; ?>" 
                                />
                            </div>
                        </div>
                        <div class="mb-3 col-md-6">
    ...
    <input type="hidden" name="cid[]" id="cid" value="<?php echo $this->item->id_corredor; ?>" />
    <input type="hidden" name="id_corredor" value="<?php echo $this->item->id_corredor; ?>" />
    <input type="hidden" name="controller" value="corredor" />
    <input type="hidden" name="view" value="corredor" />
