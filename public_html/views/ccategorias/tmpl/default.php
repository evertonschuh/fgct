...
<form method="post" name="adminForm">
                    ...
                    <div class="col-md-10">
                        <div class="dt-action-buttons text-xl-end text-lg-start text-md-end text-start d-flex align-items-center justify-content-end flex-md-row flex-column mb-3 mb-md-0">
                            ...
                            <div class="dt-buttons btn-group flex-wrap">
                                ...
                                <a class="btn add-new btn-primary" href="<?php echo JRoute::_('index.php?view=ccategoria&cid=');?>">
                                    <span>
                                        <i class="bx bx-plus me-0 me-sm-1"></i>
                                        <span class="d-none d-sm-inline-block">Adicionar Nova Categoria</span>
                                    </span>
                                </a> 
                            </div>
                        </div>
                ...
                <table class="datatables-users table border-top dataTable no-footer dtr-column">
                    <thead>
                        <tr>
                            ...
                            <th class="sorting sorting_desc"><?php echo JHtml::_('grid.sort',  'Nome', 'name_corredor_categoria', $listDirn, $listOrder); ?></th>
                            <th class="sorting text-center"><?php echo JHtml::_('grid.sort', 'Atletas Vinculados', 'total_corredor_categoria', $listDirn, $listOrder); ?></th>
                            <th class="sorting text-center"><?php echo JHtml::_('grid.sort', 'Status', 'status_corredor_categoria', $listDirn, $listOrder); ?></th>
    ...
    <input type="hidden" name="controller" value="ccategorias" />
    <input type="hidden" name="view" value="ccategorias" />
