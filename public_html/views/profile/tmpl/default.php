                                                    ...
                                                    <div class="col-lg-6">
                                                    	<div class="form-group">
                                                            ...
                                                            <select id="id_estado" name="id_estado" class="form-control estado select2">
                                                                ...
                                                                <option disabled selected class="default" value=""><?php echo JText::_('FBT_GLOBAL_ESTADO'); ?></option>
                                                                <?php } ?>
                                                    ...
                                                    <div class="col-lg-6">
                                                    	<div class="form-group">
                                                            ...
                                                            <select id="id_cidade" name="id_cidade" class="form-control select2">
                                                               ...
                                                               <option disabled selected class="default" value=""><?php echo JText::_('FBT_GLOBAL_CIDADE'); ?></option>
                                                                <?php }                                                    
