...
class EASistemasControllerMemberShipCards extends JController
{
	public function display($cachable = false, $urlparams = array())
	{
		JRequest::setVar('view', 'membershipcards');	
	...
	function remove()
	{
		JRequest::checkToken() or jexit('JINVALID_TOKEN');
		JRequest::setVar('view', 'membershipcards');
		$model = $this->getModel('membershipcards');
		if ($model->remove()) {
		...
		$this->setRedirect(JRoute::_('index.php?view=membershipcards', false), $msg, $msgType);
	}
