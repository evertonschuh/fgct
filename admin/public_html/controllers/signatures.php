...
class EASistemasControllerSignatures extends JController
{
	public function display($cachable = false, $urlparams = array())
	{
		JRequest::setVar('view', 'signatures');	
	...
	function remove()
	{
		...
		JRequest::setVar('view', 'signatures');
		$model = $this->getModel('signatures');
		if ($model->remove()) {
		...
		$this->setRedirect(JRoute::_('index.php?view=signatures', false), $msg, $msgType);
	}
