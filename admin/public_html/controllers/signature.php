...
class EASistemasControllerSignature extends JController {
	...
	function save()
	{
		...
		$this->setRedirect(JRoute::_('index.php?view=signature&cid[]=' . $model->_id, false), $msg, $msgType);
	}
	...
	function cancel()
	{
		...
		$model->checkin();
		JRequest::setVar( 'hidemainmenu', 0 );
		$this->setRedirect(JRoute::_('index.php?view=signatures', false));
	}
