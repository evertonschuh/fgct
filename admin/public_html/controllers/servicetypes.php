...
class EASistemasControllerServiceTypes extends JController
{
	public function display($cachable = false, $urlparams = array())
	{
		JRequest::setVar('view', 'servicetypes');	
	...
	function remove()
	{
		...
		JRequest::setVar('view', 'servicetypes');
		$model = $this->getModel('servicetypes');
		if ($model->remove()) {
		...
		$this->setRedirect(JRoute::_('index.php?view=servicetypes', false), $msg, $msgType);
	}
