...
<form method="post" name="adminForm">
        ...
        <div class="card-datatable table-responsive">
                    ...
                    <div class="col-md-10">
                        <div class="dt-action-buttons text-xl-end text-lg-start text-md-end text-start d-flex align-items-center justify-content-end flex-md-row flex-column mb-3 mb-md-0">
                            ...
                            <div class="dt-buttons btn-group flex-wrap">
                                <a class="btn btn-secondary add-new btn-primary" href="<?php echo JRoute::_('index.php?view=mailmessage&cid=');?>">
                                    <span>
                                        <i class="bx bx-plus me-0 me-sm-1"></i>
                                        <span class="d-none d-sm-inline-block">Nova Mensagem</span>
                                    </span>
                                </a> 
                            </div>
                        </div>
            ...
            <div class="dataTables_wrapper dt-bootstrap5 no-footer ">
                <table class="datatables-users table border-top dataTable no-footer dtr-column">
                    <thead>
                        <tr>
                            <th class="sorting sorting_desc"><?php echo JHtml::_('grid.sort',  'Motivo do Disparo', 'name_mailmessage_occurrence', $listDirn, $listOrder); ?></th>
                            <th class="sorting text-center"><?php echo JHtml::_('grid.sort', 'Status', 'status_mailmessage', $listDirn, $listOrder); ?></th>
                            <th class="sorting text-center"><?php echo JHtml::_('grid.sort',  'Id', 'id_mailmessage_occurrence', $listDirn, $listOrder); ?></th>
    ...
    <input type="hidden" name="controller" value="mailmessages" />
    <input type="hidden" name="view" value="mailmessages" />
