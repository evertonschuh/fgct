...
<form method="post" name="adminForm">
        ...
        <div class="card-datatable table-responsive">
            <div class="dataTables_wrapper dt-bootstrap5 no-footer ">
                    ...
                    <div class="col-md-10">
                        <div class="dt-action-buttons text-xl-end text-lg-start text-md-end text-start d-flex align-items-center justify-content-end flex-md-row flex-column mb-3 mb-md-0">
                            ...
                            <div class="dt-buttons btn-group flex-wrap">
                                <a class="btn btn-secondary add-new btn-primary" href="<?php echo JRoute::_('index.php?view=mailmessagetheme&cid=');?>">
                                    <span>
                ...
                <table class="datatables-users table border-top dataTable no-footer dtr-column">
                    <thead>
                        <tr>
                            <th class="sorting sorting_desc"><?php echo JHtml::_('grid.sort',  'Nome', 'name_mailmessage_theme', $listDirn, $listOrder); ?></th>
                            <th class="sorting text-center"><?php echo JHtml::_('grid.sort', 'Status', 'status_mailmessage_theme', $listDirn, $listOrder); ?></th>
                            <th class="sorting text-center"><?php echo JHtml::_('grid.sort', 'id', 'id_mailmessage_occurrence_theme', $listDirn, $listOrder); ?></th>
    ...
    <input type="hidden" name="controller" value="mailmessagethemes" />
    <input type="hidden" name="view" value="mailmessagethemes" />
