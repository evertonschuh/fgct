...
.page1, .page {
	background-image:url("/media/assets/img/ptimbrado/<?php echo $this->item->skin_documento ?>.jpg");
...
<div class="page1 page">
	...
	<img class="img-qrcode" src="../media/assets/img/ptimbrado/qr_code_exemplo.jpg" />
</div>