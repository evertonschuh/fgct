...
$(document).ready(function(){
	...
	$('#id_pagamento_produto_tipo').change(function(){
		$('#user_id').html('<option value="0">'+Joomla.JText._('EASISTEMAS_SCRIPT_SELET_LOADING')+'</option>');
		$('#id_pagamento_produto').html('<option value="0">'+Joomla.JText._('EASISTEMAS_SCRIPT_SELET_LOADING')+'</option>');
