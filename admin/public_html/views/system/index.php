          ...
          <ul class="menu-inner py-1 ps ps--active-y">
            ...
            <li class="menu-item">
              <a href="<?php echo JRoute::_('index.php?view=updates');?>" class="menu-link">
                ...
                <div data-i18n="Account">Atualizações</div>
              </a>
            </li>
            ...
            <li class="menu-item">
              <a href="<?php echo JRoute::_('index.php?view=updates');?>" class="menu-link">
                ...
                <div data-i18n="Account">Solicitações</div>
              </a>
            </li>
            <li class="menu-header small text-uppercase">
            ...
            <li class="menu-item">
                <a href="<?php echo JRoute::_('index.php?view=weapons');?>" class="menu-link">
                  ...
                  <div data-i18n="Minhas Armas">Armas</div>
                </a>
              </li>
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx  bx-add-to-queue"></i>
                <div class="text-truncate" data-i18n="Cadastros Adicionais">Outros Cadastros</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                ...
                <li class="menu-item">
                  <a href="<?php echo JRoute::_('index.php?view=treinos');?>" class="menu-link">
                    <div data-i18n="Account">Equipes</div>
                  </a>
                </li>
              </ul>
            </li>
            <?php /*
            <li class="menu-item">
              <a href="<?php echo JRoute::_('index.php?view=archivedocuments'); ?>" class="menu-link">
            ...
            */ ?>
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div class="text-truncate" data-i18n="financeiro">Financeiro</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item" >
                  <a href="javascript:void(0);" class="menu-link menu-toggle">
                    <div class="text-truncate" data-i18n="Receitas">Receitas</div>
                  </a>
                  <ul class="menu-sub">
                    <li class="menu-item">
                      <a href="<?php echo JRoute::_('index.php?view=cobrancas');?>" class="menu-link">
                        <div class="text-truncate" data-i18n="Account">Cobranças</div>
                      </a>
                    </li>
                    <li class="menu-item">
                      <a href="<?php echo JRoute::_('index.php?view=taxas');?>" class="menu-link">
                        <div class="text-truncate" data-i18n="Notifications">Taxas de Inscrições</div>
                      </a>
                    </li>
                  </ul>
                </li>
                  ...
                  <ul class="menu-sub">
                    <li class="menu-item">
                      <a href="1.html" class="menu-link">
                        <div data-i18n="Anuidades">Anuidades</div>
                      </a>
                    </li>
                    <li class="menu-item">
                ...
                <li class="menu-item">
                  <a href="javascript:void(0);" class="menu-link menu-toggle">
                    <div data-i18n="Arquivos">Arquivos</div>
                  </a>
                  <ul class="menu-sub">
                    <li class="menu-item">
                      <a href="3.html" class="menu-link">
                        <div data-i18n="Retorno">Retorno</div>
                      </a>
                    </li>
                    <li class="menu-item">
                      <a href="4.html" class="menu-link">
                        <div data-i18n="Remessa">Remessa</div>
                      </a>
                    </li>
                  </ul>
                </li>
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="<?php echo JRoute::_('index.php?view=dmodels'); ?>" class="menu-link">
                    <div data-i18n="Modelos">Modelos</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="<?php echo JRoute::_('index.php?view=signatures'); ?>" class="menu-link">
                    <div data-i18n="Assinaturas">Assinaturas</div>
                  </a>
                </li>
              </ul>
            </li> 
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="<?php echo JRoute::_('index.php?view=mailmessages'); ?>" class="menu-link">
                    <div data-i18n="Mensagens">Mensagens</div>
                  </a>
                </li>
                <?php /*
                <li class="menu-item">
                  <a href="<?php echo JRoute::_('index.php?view=mailmanmessages'); ?>" class="menu-link">
                    <div data-i18n="Account">Ocorrencia de Disparo</div>
                  </a>
                </li>
                */ ?>
                <li class="menu-item">
                  <a href="<?php echo JRoute::_('index.php?view=mailmessagethemes'); ?>" class="menu-link">
                    <div data-i18n="Modelos">Modelos</div>
                  </a>
                </li>
              </ul>
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="<?php echo JRoute::_('index.php?view=servicetypes'); ?>" class="menu-link">
                    <div data-i18n="Modelos">Tipos</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="<?php echo JRoute::_('index.php?view=archivedocuments'); ?>" class="menu-link">
                    <div data-i18n="Modelos">Arquivo Geral</div>
                  </a>
                </li>
              </ul>
            </li>
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Pedidos">Tabelas</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="<?php echo JRoute::_('index.php?view=servicetypes'); ?>" class="menu-link">
                    <div data-i18n="Modelos">Calibres de Armas</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="<?php echo JRoute::_('index.php?view=archivedocuments'); ?>" class="menu-link">
                    <div data-i18n="Modelos">Espécie de Armas</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="<?php echo JRoute::_('index.php?view=archivedocuments'); ?>" class="menu-link">
                    <div data-i18n="Modelos">Marcas de Armas</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="<?php echo JRoute::_('index.php?view=archivedocuments'); ?>" class="menu-link">
                    <div data-i18n="Modelos">Métodos de Pagamento</div>
                  </a>
                </li>
              </ul>
            </li>
