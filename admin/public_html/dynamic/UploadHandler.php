...
class UploadHandler
{
    ...
    protected $error_messages = array(
        ...
        'post_max_size' => 'O arquivo enviado excede a diretiva post_max_size no php.ini',
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null) {
		...
		$folder = JRequest::getVar( 'folder', '', 'GET' );
		
		$this->response = array();
		
        $this->options = array(
            'script_url' => $this->get_full_url().'/'.$this->basename($this->get_server_var('SCRIPT_NAME')) . '?folder='. $folder,
            'upload_dir' => JPATH_MEDIA. DS .'digitalFiles' . DS . $folder . DS ,
            'upload_url' => '/midias/digitalFiles/' . $folder . '/',
    ...
    protected function get_file_object($file_name) {
        if ($this->is_valid_file_object($file_name)) {
            ...
            //$file->lastModified = gmdate('D, d M Y H:i:s T',filemtime($this->get_upload_path($file->name)));
