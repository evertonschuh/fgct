        ...
        <div class="card mb-4">
          <div class="card-header sticky-element d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row">
            ...
            <div class="action-btns">
              <a  class="btn btn-outline-secondary">Imprimir</a>
            </div>
          </div>
          <hr class="my-0" />
              ...
              <div class="col-xxl-6  mb-3 d-flex justify-content-center align-items-center flex-column flex-sm-row">
                <div class="card shadow-none border-0 text-white" style="width:404px; height:256px">
                  ...
                  <div class="card-img-overlay card-img-overlay-back">
                      ...
                      <span style="display: inline-block; line-height:22px; text-align: center; margin: 10px 6px; width:112px; font-size: 0.7375rem; color: <?php echo !empty($this->item->color_back_carteira_digital) ? $this->item->color_back_carteira_digital : '#000';?>"><?php echo $this->item->numcr_pf;?></span>
                      <span style="display: inline-block; line-height:22px; text-align: center; margin: 10px 0 0 8px; width:112px; font-size: 0.7375rem; color: <?php echo !empty($this->item->color_back_carteira_digital) ? $this->item->color_back_carteira_digital : '#000';?>"><?php echo $this->item->cpf_pf;?></span>
                      <span style="display: inline-block; line-height:22px; text-align: center; margin: 10px 0 0 10px; width:90px; font-size: 0.7375rem; color: <?php echo !empty($this->item->color_back_carteira_digital) ? $this->item->color_back_carteira_digital : '#000';?>"><?php echo JHtml::date(JFactory::getDate($this->item->validate_associado, $siteOffset)->toISO8601(), 'DATE_FORMAT', true);?></span>
                      <img style="float:right;margin-top: 4px;margin-right: -1px;" src="/cache/<?php echo 'qrcode-' . $namecode.  '.png';?>" />
                  </div>
                </div>
              </div>   
            </div>
