...
class TorneiosClassesSkeet {
	...
	{   
		...
		$document->addStyleSheet( 'administrator/components/com_torneios/classes/css/skeet.css?v=' . $token );	
		...
		$extension_custon = $extension . '_skeet';
	...
	function getClassificacao( $options = array() )
	{
		...
		$query->select( 'SUM(Resultados.rf) as rAddColsBefore2');
