...
class TorneiosClassesSulMinas {
	...
	{   
		...
		$document->addStyleSheet( 'administrator/components/com_torneios/classes/css/sulminas.css?v=' . $token  );	
		$document->addScript( 'administrator/components/com_torneios/classes/js/sulminas.js?v=' . $token  );	
		...
		$extension_custon = $extension . '_sulminas';
