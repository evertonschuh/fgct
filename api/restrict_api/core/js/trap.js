...
jQuery(function () {
	...
	function loadAAgenda (sel, prova){
		...
		if(jQuery('#agenda_prova' + prova).val()!='')
		{
			...
			for(i=1;i<=total;i++)
			{
				...
				if(sel>1)
				{
					jQuery('#fgct200_'+prova).attr( 'disabled', false);
					jQuery('#cbte200_'+prova).attr( 'disabled', false);
					jQuery('#liga200_'+prova).attr( 'disabled', false);					
				}
				else
				{
					jQuery('#fgct200_'+prova).attr( 'disabled', true);
					jQuery('#cbte200_'+prova).attr( 'disabled', true);
					jQuery('#liga200_'+prova).attr( 'disabled', true);
					jQuery('#cbte200_'+prova).prop('checked', false);
					jQuery('#liga200_'+prova).prop('checked', false);
				}
			}
		}
	}
	...
	/*
    jQuery('.button-inscri span').on('click', function(){
